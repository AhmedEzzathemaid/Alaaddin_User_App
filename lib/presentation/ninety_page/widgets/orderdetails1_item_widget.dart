            ...
            child: Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text(
                      orderdetails1ItemModelObj.orderNumber!,
                      style: theme.textTheme.titleMedium,
                    ),
                    SizedBox(height: 1.v),
                    Text(
                      orderdetails1ItemModelObj.productCount!,
                      style: theme.textTheme.bodyMedium,
                    ),
                    SizedBox(height: 2.v),
                    Text(
                      orderdetails1ItemModelObj.totalAmount!,
                ...
                Padding(
                  ...
                  child: Text(
                    orderdetails1ItemModelObj.deliveryTime!,
                ...
                Padding(
                  ...
                  child: CustomIconButton(
                    ...
                    child: CustomImageView(
                      imagePath: orderdetails1ItemModelObj?.iconButton,
                    ),
                  ),
                ),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        orderdetails1ItemModelObj.deliveryPoint!,
                        style: theme.textTheme.titleSmall,
                      ),
                      Text(
                        orderdetails1ItemModelObj.deliveryTimeFrame!,
                        style: theme.textTheme.bodySmall,
                      ),
                    ],
                  ),
