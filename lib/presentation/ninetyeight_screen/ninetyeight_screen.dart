...
import 'bloc/ninetyeight_bloc.dart';
import 'models/ninetyeight_model.dart';
import 'models/productdetails2_item_model.dart';
import 'widgets/productdetails2_item_widget.dart';

class NinetyeightScreen extends StatelessWidget {
  const NinetyeightScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<NinetyeightBloc>(
      create: (context) => NinetyeightBloc(NinetyeightState(
        ninetyeightModelObj: NinetyeightModel(),
      ))
        ..add(NinetyeightInitialEvent()),
      child: NinetyeightScreen(),
    );
  }
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: _buildElHodaStore(
                            ...
                            storeName: "lbl_el_nor_store".tr,
                            rating: "lbl_4_8".tr,
                            ratingCount: "lbl_574_ratings".tr,
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: _buildElHodaStore(
                            ...
                            storeName: "lbl_el_hoda_store".tr,
                            rating: "lbl_4_8".tr,
                            ratingCount: "lbl_574_ratings".tr,
                          ),
                        ),
  ...
  Widget _buildProductDetails(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(left: 2.h),
      child: BlocSelector<NinetyeightBloc, NinetyeightState, NinetyeightModel?>(
        selector: (state) => state.ninetyeightModelObj,
        builder: (context, ninetyeightModelObj) {
          return ListView.separated(
            ...
            itemCount: ninetyeightModelObj?.productdetails2ItemList.length ?? 0,
            itemBuilder: (context, index) {
              Productdetails2ItemModel model =
                  ninetyeightModelObj?.productdetails2ItemList[index] ??
