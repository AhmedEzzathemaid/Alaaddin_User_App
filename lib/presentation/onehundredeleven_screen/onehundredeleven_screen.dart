...
import 'bloc/onehundredeleven_bloc.dart';
import 'models/onehundredeleven_model.dart';

class OnehundredelevenScreen extends StatelessWidget {
  const OnehundredelevenScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<OnehundredelevenBloc>(
      create: (context) => OnehundredelevenBloc(OnehundredelevenState(
        onehundredelevenModelObj: OnehundredelevenModel(),
      ))
        ..add(OnehundredelevenInitialEvent()),
      child: OnehundredelevenScreen(),
    );
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: BlocSelector<OnehundredelevenBloc,
                        OnehundredelevenState, TextEditingController?>(
