...
import 'bloc/onehundredfiftythree_bloc.dart';
import 'models/onehundredfiftythree_model.dart';

class OnehundredfiftythreeScreen extends StatelessWidget {
  const OnehundredfiftythreeScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<OnehundredfiftythreeBloc>(
      create: (context) => OnehundredfiftythreeBloc(OnehundredfiftythreeState(
        onehundredfiftythreeModelObj: OnehundredfiftythreeModel(),
      ))
        ..add(OnehundredfiftythreeInitialEvent()),
      child: OnehundredfiftythreeScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: BlocSelector<OnehundredfiftythreeBloc,
                          OnehundredfiftythreeState, TextEditingController?>(
        ...
        bottomNavigationBar: _buildWriteHere(context),
      ),
    );
  }
