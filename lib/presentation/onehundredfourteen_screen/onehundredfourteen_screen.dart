...
import 'bloc/onehundredfourteen_bloc.dart';
import 'models/onehundredfourteen_model.dart';

class OnehundredfourteenScreen extends StatelessWidget {
  OnehundredfourteenScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<OnehundredfourteenBloc>(
      create: (context) => OnehundredfourteenBloc(OnehundredfourteenState(
        onehundredfourteenModelObj: OnehundredfourteenModel(),
      ))
        ..add(OnehundredfourteenInitialEvent()),
      child: OnehundredfourteenScreen(),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: BlocSelector<OnehundredfourteenBloc, OnehundredfourteenState,
                bool?>(
  ...
  /// Section Widget
  Widget _buildCloseUpOfDefect(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(left: 2.h),
      child: BlocSelector<OnehundredfourteenBloc, OnehundredfourteenState,
          TextEditingController?>(
        selector: (state) => state.closeUpOfDefectController,
        builder: (context, closeUpOfDefectController) {
          return CustomTextFormField(
            controller: closeUpOfDefectController,
