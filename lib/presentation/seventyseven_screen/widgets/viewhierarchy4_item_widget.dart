...
class Viewhierarchy4ItemWidget extends StatelessWidget {
  ...
  Viewhierarchy4ItemModel viewhierarchy4ItemModelObj;
      ...
      children: [
        Container(
          ...
          child: Row(
            ...
            children: [
              CustomImageView(
                imagePath: viewhierarchy4ItemModelObj?.cashImage,
                height: 32.adaptSize,
                width: 32.adaptSize,
              ...
              Padding(
                ...
                child: Text(
                  viewhierarchy4ItemModelObj.cashText!,
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              CustomImageView(
                imagePath: viewhierarchy4ItemModelObj?.cashImage1,
                height: 27.adaptSize,
                width: 27.adaptSize,
                ...
                child: Stack(
                  ...
                  children: [
                    Align(
                      ...
                      child: Text(
                        viewhierarchy4ItemModelObj.walletText!,
                        style: theme.textTheme.titleMedium,
                      ),
                    ),
                    Align(
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                viewhierarchy4ItemModelObj.amountText!,
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              CustomImageView(
                imagePath: viewhierarchy4ItemModelObj?.bankTransferImage,
                height: 29.adaptSize,
                width: 29.adaptSize,
                margin: EdgeInsets.only(bottom: 2.v),
              ),
              Padding(
                ...
                child: Text(
                  viewhierarchy4ItemModelObj.bankTransferText!,
                  style: theme.textTheme.titleMedium,
                ),
              ),
              Spacer(),
