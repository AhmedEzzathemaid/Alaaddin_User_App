...
import 'bloc/seventytwo_bloc.dart';
import 'models/seventytwo_model.dart';

// ignore_for_file: must_be_immutable
class SeventytwoBottomsheet extends StatelessWidget {
  const SeventytwoBottomsheet({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<SeventytwoBloc>(
      create: (context) => SeventytwoBloc(SeventytwoState(
        seventytwoModelObj: SeventytwoModel(),
      ))
        ..add(SeventytwoInitialEvent()),
      child: SeventytwoBottomsheet(),
    );
  }
