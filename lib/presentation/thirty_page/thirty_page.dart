...
import 'bloc/thirty_bloc.dart';
import 'models/thirty_model.dart';

// ignore_for_file: must_be_immutable
class ThirtyPage extends StatefulWidget {
  const ThirtyPage({Key? key})
      : super(
          key: key,
        );

  @override
  ThirtyPageState createState() => ThirtyPageState();
  static Widget builder(BuildContext context) {
    return BlocProvider<ThirtyBloc>(
      create: (context) => ThirtyBloc(ThirtyState(
        thirtyModelObj: ThirtyModel(),
      ))
        ..add(ThirtyInitialEvent()),
      child: ThirtyPage(),
    );
  }
}
...
class ThirtyPageState extends State<ThirtyPage>
    with AutomaticKeepAliveClientMixin<ThirtyPage> {
  @override
  bool get wantKeepAlive => true;
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ThirtyBloc, ThirtyState>(
