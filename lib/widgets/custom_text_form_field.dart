...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget textFormFieldWidget(BuildContext context) => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodyMediumWhiteA700_1,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.titleSmall15_1,
        prefixIcon: prefix,
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get outlinePrimaryTL4 => OutlineInputBorder(
  ...
  static OutlineInputBorder get outlineGrayTL25 => OutlineInputBorder(
